...
export const SiteFooter = () => {
  return (
    <footer className="mt-32 border-t border-hairline bg-primary text-primary-foreground">
      <div className="max-w-[1240px] mx-auto px-6 lg:px-10 py-16 grid gap-12 lg:grid-cols-[1fr_2fr] items-start">
        ...
        <div className="grid sm:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <a
              ...
              className="font-serif text-lg leading-snug hover:text-gold transition-colors"
            >
      ...
      <div className="border-t border-paper/10">
        <div className="max-w-[1240px] mx-auto px-6 lg:px-10 py-5 flex flex-wrap items-center justify-between gap-3 font-mono text-[0.65rem] uppercase tracking-[0.18em] text-paper/55">
